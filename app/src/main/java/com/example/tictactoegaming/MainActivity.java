package com.example.tictactoegaming;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(View v)
    {
        ...
        {
            ((Button) v).setText("X");
            v.setBackgroundResource(R.drawable.phil);
        }
        else {
            ((Button) v).setText("O");
            v.setBackgroundResource(R.drawable.todd);
        }
    ...
    private void draw() {
        ...
        work = MediaPlayer.create(this,R.raw.work);
        work.start();
        ...
        for(int i = 0; i < 3; i++) {
            for(int j = 0; j < 3; j++) {
                ...
                if(thisButton.getText() == "X") {
                    thisButton.setBackgroundResource(R.drawable.phil);
                }
                else if(thisButton.getText() == "O") {
                    thisButton.setBackgroundResource(R.drawable.todd);
                }
            }
        }
    }
